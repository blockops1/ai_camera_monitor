...
- README rewritten for public audience (operator paths and internal IPs
  removed).
- Listener test files and Synology-specific code paths removed.
- Internal docs (PLAN.md, AGENTS.md, PROJ-farm-surveillance.md,
  ARCHITECTURE.md) excluded from public release.

### Removed
- Synology-specific preview backend (`infra/synology_preview.py`).
