...
### ml-paper-writing (archived — merged 2026-05-08)
> Absorbed into `research-paper-writing`. Covered ML/AI paper writing for NeurIPS/ICML/ICLR/ACL/AAAI/COLM with emphasis on camera-ready submissions, citation verification, and LaTeX templates. All content is covered by the phases above — particularly Phase 1 (Literature Review) and Phase 5 (Camera-Ready). No functionality was lost.
