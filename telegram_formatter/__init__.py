...
PUBLIC API:
    ...
    from telegram_formatter.motion_telegram import (
        ...
        build_minimal_motion_telegram_body,  # Phase.89 — first-alert body
    )
...
# shadowing that previously broke OFS/OFG vehicle arrivals (2026-08-19)
# AND free of the heavy cv2/numpy dependency chain that the composite
# renderer pulls in (Phase.111).
