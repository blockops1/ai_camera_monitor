...
class CompositeTelegramInput:
    ...
    detected" per the operator's spec (2026-08-21).
...
def build_composite_telegram_body(input: CompositeTelegramInput) -> str:
    ...
    The header uses <b>Vehicle in motion at</b> per the operator's spec
    ...
    the operator's correction ("it is actually fine to leave it as the
    webhook time").
    """
    lines: list[str] = []
