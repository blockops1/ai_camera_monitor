...
Phase.142 (2026-08-27, Note): match/no-match Telegrams now
...
class TestSendMatchAlertAlbum:
    """Phase.142: match alert sends body + 2-image tight-crop album."""
    ...
    def test_sends_body_via_send_message(self, tmp_path, monkeypatch):
        ...
        assert "CAM1" in args[2]  # bot_token, chat_id, text
...
class TestSendNoMatchAlertAlbum:
    """Phase.142: no-match alert sends body + 2-image tight-crop album."""
