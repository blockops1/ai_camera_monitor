...
INPUTS:
    - env vars:
        ...
        ai_camera_monitor_PRODUCTION — when "1", enables production paths
...
RELATED:
    ...
    - PLAN.md §11.61 — Phase 6B.140 (2026-08-27) FDO → OFG person-gatekeeper swap
...
or
    ai_camera_monitor/.venv/bin/python \\
        ai_camera_monitor/listener/listener.py
...
# ai_camera_monitor. Nothing in this file references
# /Users/jill/ai_camera_monitor/src/.
...
# PRODUCTION_MODE (env ai_camera_monitor_PRODUCTION=1) gates the file handler;
...
def _process_alert(
    ...
    try:
        from infra.cameras import by_code, has_rtsp
    except ImportError:  # pragma: no cover
        from listener.infra.cameras import by_code, has_rtsp  # type: ignore
    try:
    ...
    # across cameras (property-wide) per maintainer 2026-09-02 PM.
    try:
