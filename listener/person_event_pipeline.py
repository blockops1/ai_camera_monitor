...
WHY HERE:
    Mirrors vehicle_event_pipeline's context-object pattern per Note's
...
def _collect_person_album_paths(output_dir: str) -> list[str]:
    ...
    crop_paths = sorted(
        ...
        and p.endswith(".png")
        and not p.endswith("_tight.png")  # skip _tight variants (Phase.142)
...
def process_person_event(ctx: PersonContext) -> dict:
    ...
    Note 2026-08-27: *"I'd like it to work more like the vehicle
