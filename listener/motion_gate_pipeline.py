...
the bbox during the 1-2s inter-frame interval (maintainer: "about half
...
def run(
    ...
    # No V2 carve-out — if diff is empty, suppress. maintainer 2026-09-01:
    ...
    # ---- classify both crops ----
    # Phase 6B.115 (§11.46.6): when GATE_KEEP_DISK_ARTIFACTS=true the
