...
# Phase 6B.128 — OFS gatekeeper gets a 4-frame pre-event motion trail
# (indices [0, 30, 60, 90] at 15fps → T-6s through T+0s of camera time,
# 2s spacing). All other cameras keep the trailing-tail behavior.
#
# Phase 6B.143 (2026-08-27, maintainer OOB): OFG (Outside Front Garage) joins
...
def maybe_run_motion_gate(
    ...
    # Phase 6B.128 — gatekeeper cameras (OFS) sample 4 evenly-spaced frames
