...
PUBLIC API:
    AlertContext
        ...
        Phase 6B.168: camera_code populated by listener once at construction —
...
class AlertContext:
    ...
    # webhook and gatekeeper_cameras contains CAM{N} codes (Phase 6B.167
    # §13.4/§13.5). Phase 6B.168 (2026-08-31): boundary translation done
    # once at construction, not at every membership check.
    camera_code: str = ""

    # NOTE: Phase 6B.168 deliberately does NOT auto-derive camera_code
    ...
    # ---- Phase 6B.108a (§11.38.5): gate-aware capture inputs ---------------
    ...
    # (Phase 6B.115: legacy_capture_avoided was REMOVED — there's no
    ...
    # ---- Stage 1 outputs (capture) ---------------------------------------
    # Phase 6B.115: in-memory frames + crops from the gate (authoritative).
    ...
    # Phase 6B.144 (§11.66): path to the gate's pairwise differential
    ...
    # Phase 6B.121 (2026-08-22): list of MatchTelegramInput the match
