...
WHY HERE:
    Extracted from listener.py on 2026-08-21 (Phase.105c). The pipeline
...
# Fixed EDT (UTC-4) per the operator 2026-08-19 ("US Congress has decided that we're
...
# to EST in November and would re-introduce the UTC-leak bug Phase.99
