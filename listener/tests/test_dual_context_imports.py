...
Phase.108a-rev1 caught a ModuleNotFoundError in production because
...
def test_lazy_motion_gate_imports_in_main_mode_6B161():
    """Regression for Bug 2 (Phase.161, 2026-08-28):
...
def test_listener_lazy_imports_work_with_real_gate_pass_verdict_6B161():
    """End-to-end regression for Bug 2 (Phase.161, 2026-08-28):
    ...
    (the path that crashed 46 times today on CAM2 f197bbf8 and others).
