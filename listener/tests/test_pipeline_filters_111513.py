...
class TestPipelineCooldownAnimal:
    ...
    def test_animal_no_match_arms(self) -> None:
        ...
        Per Note 2026-09-02 PM "once I see an animal": any detection
...
class TestPipelineCooldownPropertyWide:
    ...
    Per Note 2026-09-02 PM: "I want to cool down on all cameras
