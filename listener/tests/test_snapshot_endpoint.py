...
maintainer asks Jill in chat for "an CAM1 snapshot" (or CAM2). Jill curls
...
def test_resolve_snapshot_camera_maps_CAM2_to_canonical():
    """Phase 6B.167 §13.4 Commit 17: CAM2 → CAM3 (OUTSIDE_FRONT_GARAGE)."""
...
def test_resolve_snapshot_camera_returns_None_for_unknown():
    cams = _make_cameras()
    assert _resolve_snapshot_camera("XYZ", cams) is None  # unknown alias — §11.80 added CAM5/BACK/CAM1/CAM4 to the alias map
