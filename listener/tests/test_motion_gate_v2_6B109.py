...
# ---------------------------------------------------------------------------
# F1: removed in Phase.171 STRICT commit. V2's full-frame YOLO
...
# (Phase.171 STRICT commit removed V2's full-frame YOLO backstop)
# ---------------------------------------------------------------------------
...
def test_no_motion_suppresses_in_v2_no_fallback(monkeypatch, tmp_path):
    """V2 (Phase.171 STRICT): when no diff fires, gate suppresses — no
    V2 full-frame YOLO backstop. Note 2026-09-01: 'I don't want a V2
