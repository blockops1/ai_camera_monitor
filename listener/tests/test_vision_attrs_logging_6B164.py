"""
test_vision_attrs_logging_6B164.py — Tests for Phase.164 logging additions.

Phase.164 (2026-08-29): added vision_attrs structured log line so the
...
def test_no_match_log_includes_best_confidence(caplog):
    """NoMatch path now logs best_confidence (Phase.164)."""
    ...
    assert "best_candidate='name one'" in text
