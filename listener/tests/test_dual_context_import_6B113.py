"""Regression test for the dual-context import bug in vehicle_event_pipeline
and person_event_pipeline. Phase.108a shipped listener/_gate_aware_capture.py
...
def test_process_alert_imports_in_production_environment():
    ...
    #              from vehicle_event_pipeline import process_alert"
...
@pytest.mark.parametrize(
    "module,func_name",
    [
        ("vehicle_event_pipeline", "process_alert"),
