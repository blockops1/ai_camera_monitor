"""
Phase.167 §13.5 Commit 14 — _zone_for(camera_code) helper tests.
...
class TestPhase6B167ZoneFor:
    ...
    def test_zone_for_code_only_no_name_translation(self, tmp_path):
        ...
        Phase.167 §13.4 Commit 17 (T3 C17): CAM{N} codes are the
        canonical camera identifiers; legacy prefixes (e.g.
        CAM1) are translated to CAM5 by the legacy env
