...
WHY HERE:
    PLAN §11.86 (Phase 6B.165) — animal pipeline as the third
    class-parallel sibling of person and vehicle. Per maintainer 2026-08-29,
...
def process_animal_event(ctx: AnimalContext) -> dict:
    ...
    Phase 6B.165.1 (PLAN §11.86.1) — prove the dispatch route works
