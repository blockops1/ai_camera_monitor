...
STATUS: stable (Phase 6B.165 §11.86.5, 2026-08-30)
...
Phase 6B.165 §11.86.5 (2026-08-30) — initial scaffold. Mirrors
...
try:
    ...
    if str(Path(_DEFAULT_PATH).resolve()) != str(Path(_ANIMALS_PATHS_FILE).resolve()):
        ...
        # monkeypatched ai_camera_monitor_ROOT, so this divergence is
        ...
        warnings.warn(
            ...
            "Check ai_camera_monitor_ROOT / ai_camera_monitor_DATA_DIR env vars.",
            stacklevel=2,
        )
except ImportError:
...
def load_known_animals(
    ...
    Phase 6B.165 §11.86.5 (2026-08-30) — initial scaffold. Mirrors
    known_vehicles.load_known_vehicles (Phase 6B.83, 2026-08-16).
