...
INPUTS:
    - CLI args:
        --name    (required): display name (e.g. "maintainer", "employee_b")
...
CALLED BY:
    - manual invocation: source .venv/bin/activate && python3 scripts/enroll_person.py --name maintainer
...
# activate before running:  source REPO_PATH/.venv/bin/activate
...
def main() -> int:
    ...
    parser.add_argument(
        "--name",
        required=True,
        help='Display name (e.g. "maintainer", "employee_b")',
    )
    parser.add_argument(
        "--role",
        default="unknown",
