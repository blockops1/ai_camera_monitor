...
Phase.166 §11.87.4: parameterized with CLI flags + JSON recipe.
Phase.167 §13.5 (2026-08-30, T2 Commit 8):
...
# --- Camera registry helpers (Phase.167 §13.5 Commit 8) ---
#
...
def _resolve_camera(args):
    ...
    Phase.167 §13.5 (Commit 8): prefer --camera <code> (e.g. CAM1,
...
def open_panel(page) -> bool:
    ...
    for attempt in range(3):
        ...
        # Upper-LEFT quadrant (per the operator 2026-08-02)
