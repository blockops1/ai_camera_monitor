...
Phase 6B.166 §11.87.2 (2026-08-30):
  ...
  - env_path defaults to infra.paths.CAMERA_CREDS_FILE — was hardcoded
    to /Users/jill/ai_camera_monitor/camera-creds.env which broke
...
# --- CLI (Phase 6B.167 §13.5 Commit 7) ---
#
# Usage forms:
...
def _resolve_camera(args: argparse.Namespace):
    ...
    Phase 6B.167 §13.5: prefer --camera <code> (e.g. CAM1). Falls back to
...
def _cli_login(args: argparse.Namespace):
    ...
    Phase 6B.166 §11.87.1: replaced hardcoded FRONT_HTTP_PASS /
    BACK_HTTP_PASS branching with infra.camera_creds IP lookup.
    Phase 6B.167 §13.5 (Commit 7): --camera <code> added; --ip <addr>
