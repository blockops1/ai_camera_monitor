...
Form structure (verified 2026-07-18 on REOLINK_MODEL):
...
#
# Phase 6B.167 §13.4: removed the hardcoded operator listener IP that used to
...
def main():
    ...
    # Phase 6B.167 §13.4: enumerate cameras in declaration order.
