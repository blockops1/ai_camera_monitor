...
STATUS: provisional (Phase 6B.166 §11.87.7, 2026-08-30 — rewrote from
    ~/ai_camera_monitor/ to use the canonical dict-wrapped schema that
...
INPUTS:
    - env ai_camera_monitor_DATA_DIR (default $ai_camera_monitor_ROOT/data or
    ...
    - CLI args:
        ...
        --label         (required): human label, e.g. "Jeremiah's Chevy".
...
WHY HERE:
    ...
    from ~/ai_camera_monitor/scripts/) wrote the known_vehicles.json
...
def _label_to_id(label: str) -> str:
    ...
    Examples:
        "Jeremiah's Chevy pickup" -> "v_jeremiahs_chevy_pickup"
...
def enroll(
    ...
    *,
    ...
    Args:
        ...
        label: Human label, e.g. "Jeremiah's Chevy pickup".
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--label", required=True,
        help='Human label, e.g. "Jeremiah\'s Chevy pickup"',
    )
