...
Phase.166 §11.87.6: cameras come from infra.camera_creds; recipe comes from
...
Phase.167 §13.5 (2026-08-30, Commit 9): --camera <code> flag added.
...
# <legacy-repo>-workflow skill — 60s is generous enough that the prior
...
def _list_cameras() -> None:
    ...
    Phase.167 §13.5 (Commit 9): matches the --list-cameras flag added to
...
def _resolve_targets(args: argparse.Namespace) -> list[tuple[str, str, str]]:
    ...
    Phase.167 §13.5 (Commit 9): fleet comes from infra.cameras.load_cameras()
