...
This is the path the operator asked for on 2026-08-29: *"Use those to
...
INPUTS:
  - hardcoded crop paths (one-off script for the operator's enrollment)
...
WHY HERE:
  One-off helper for the operator's 2026-08-29 enrollment from
...
RELATED:
  ...
  - PLAN §11.85 — Phase.163 design plan
"""
...
CROPS = [
    ...
    ("CAM1", "<install-path>/ai_camera_monitor/data/frames/cf34c349-77f1-4152-9b4b-55d899d4bdb7/frame_003_crop0_205_983x1091.jpg"),
    ("CAM1", "<install-path>/ai_camera_monitor/data/frames/cf34c349-77f1-4152-9b4b-55d899d4bdb7/frame_004_crop665_324_1223x972.jpg"),
    # 5028705d — CAM3 11:28:32 (distant)
    ("CAM3", "<install-path>/ai_camera_monitor/data/frames/5028705d-18c1-4cfe-853b-6e8db422f47d/frame_003_crop170_217_207x166.jpg"),
    ("CAM3", "<install-path>/ai_camera_monitor/data/frames/5028705d-18c1-4cfe-853b-6e8db422f47d/frame_004_crop175_236_142x130.jpg"),
    # 21f02a5e — CAM1 11:28:53 (very clear)
    ("CAM1", "<install-path>/ai_camera_monitor/data/frames/21f02a5e-7b47-4594-abc2-43d10d5ffeea/frame_003_crop0_0_2304x1296.jpg"),
    ("CAM1", "<install-path>/ai_camera_monitor/data/frames/21f02a5e-7b47-4594-abc2-43d10d5ffeea/frame_004_crop547_0_1027x1273.jpg"),
    # 895c21a3 — CAM3 11:30:50 (gravel walk, clean)
    ("CAM3", "<install-path>/ai_camera_monitor/data/frames/895c21a3-d5c9-40fb-a77c-65af05dc3335/frame_003_crop418_326_254x412.jpg"),
    ("CAM3", "<install-path>/ai_camera_monitor/data/frames/895c21a3-d5c9-40fb-a77c-65af05dc3335/frame_004_crop591_527_383x611.jpg"),
    # dd88657e — CAM2 11:43:53 (partial)
    ("CAM2", "<install-path>/ai_camera_monitor/data/frames/dd88657e-1b3b-40f0-bdd3-8890126e8ef5/frame_003_crop2045_121_259x559.jpg"),
    ("CAM2", "<install-path>/ai_camera_monitor/data/frames/dd88657e-1b3b-40f0-bdd3-8890126e8ef5/frame_004_crop2041_138_263x582.jpg"),
    # 40e76d03 — CAM6 11:48:43 (hat)
    ("CAM6", "<install-path>/ai_camera_monitor/data/frames/40e76d03-b031-4708-8c0f-e266f66fcdb4/frame_003_crop704_449_347x570.jpg"),
    ("CAM6", "<install-path>/ai_camera_monitor/data/frames/40e76d03-b031-4708-8c0f-e266f66fcdb4/frame_004_crop969_534_394x568.jpg"),
    # a763c88f — CAM2 11:52:01 (hat)
    ("CAM2", "<install-path>/ai_camera_monitor/data/frames/a763c88f-2888-4294-9d62-991153521d65/frame_003_crop1674_327_211x378.jpg"),
    ("CAM2", "<install-path>/ai_camera_monitor/data/frames/a763c88f-2888-4294-9d62-991153521d65/frame_004_crop657_387_349x796.jpg"),
    # da7200d2 — CAM2 11:54:01 (hat)
    ("CAM2", "<install-path>/ai_camera_monitor/data/frames/da7200d2-1cda-4631-9a2a-b336bc96c906/frame_003_crop234_188_302x504.jpg"),
    ("CAM2", "<install-path>/ai_camera_monitor/data/frames/da7200d2-1cda-4631-9a2a-b336bc96c906/frame_004_crop264_187_307x482.jpg"),
    # 6d54dacb — CAM3 12:01:25 (hat)
    ("CAM3", "<install-path>/ai_camera_monitor/data/frames/6d54dacb-5697-492f-a70f-ff3cec095835/frame_003_crop242_516_249x514.jpg"),
    ("CAM3", "<install-path>/ai_camera_monitor/data/frames/6d54dacb-5697-492f-a70f-ff3cec095835/frame_004_crop888_486_284x438.jpg"),
]
...
NAME = "name one"  # display name; matches the operator's preference
ROLE = "owner"
