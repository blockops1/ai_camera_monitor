...
This is the path Note asked for on 2026-08-29: *"Use those to
...
INPUTS:
  - hardcoded crop paths (one-off script for Note's enrollment)
...
WHY HERE:
  One-off helper for Note's 2026-08-29 enrollment from
...
NAME = "name one"  # display name; matches Note's preference
ROLE = "owner"
