...
GROUPS: list[tuple[str, str, list[str]]] = [
    ...
    (
        ...
        [
            "infra.frame_capture",
            "infra.frame_selector",
            "infra.image_prep",
            "infra.persistent_rtsp",
            "infra.motion_detector",
            "infra.frame_diff",
    ...
    (
        ...
        [
            ...
            "vehicle_identifier.focused_pass",
        ],
    ),
    (
    ...
    <div class="cards">
      <div class="card">
        ...
        <ul>
          ...
          <li>&bull; Phase.115: pipeline extracted to listener/* modules</li>
        </ul>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <h3>Motion gate (Phase.107 + 6B.116)</h3>
        </div>
        <ul>
      ...
      <div class="card">
        ...
        <ul>
          ...
          <li>&bull; Zero coupling to <legacy-repo>/</li>
        </ul>
      </div>
    </div>
