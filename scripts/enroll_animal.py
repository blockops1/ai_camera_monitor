#!/usr/bin/env python3
"""
enroll_animal.py — Phase.165 §11.86.5 animal enrollment CLI.
...
Mirrors scripts/enroll_person.py structure (Phase.106 / 6B.163)
...
STATUS: provisional (Phase.165 §11.86.5, 2026-08-30).
...
INPUTS:
    - CLI args:
        ...
        --camera  (optional): camera name or IP. Defaults to BDI
                  (192.168.1.42) — the workshop where resident cats
...
def main() -> int:
    ...
    parser.add_argument(
        "--camera",
        default="BDI",
        help="Camera name or IP for frame capture (default: BDI).",
    )
    parser.add_argument(
        "--species",
        default=None,
