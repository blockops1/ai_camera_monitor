...
Phase.167 §13.4: positional `ip` arg deprecated; use `--camera <label>` (or
...
#
# Phase.167 §13.4: this site-specific inventory is intentionally not pinned
...
def open_alarm_settings(page) -> None:
    ...
    Critical context — burned 2026-07-26:
      ...
      click the upper-left quadrant. the operator: "the gear is weird. I had to click
    ...
    """)
    if info:
        # Click upper-left part per the operator's hint. Sometimes the click
...
def main():
    ...
    # Phase.167 §13.4: enumerate cameras in declaration order. The first
    ...
    if args.list_cameras:
        # Phase.167 §13.4: ergonomic helper. Prints the configured cameras
