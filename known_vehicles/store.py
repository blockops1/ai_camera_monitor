...
Phase.83 (2026-08-16) — load_known_vehicles() now defaults to
...
# Phase.83 (2026-08-16): canonical default-path for the project.
...
def load_known_vehicles(
    ...
    Phase.83 (2026-08-16) — previous contract was "path=None ->
