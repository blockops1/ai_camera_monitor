...
Phase 6B.100: identify_from_crops now sends ALL crops to Qwen in a
...
Removed tests (Phase 6B.100, design changed):
...
def test_empty_signature_returns_empty_signatures_fallback(
    ...
    This is the CAM1-foliage case: Qwen saw trees, not a vehicle.
    ...
    def fake_call(**kwargs):
        ...
        # Mirrors the real CAM1-foliage response (raw_vision_crop_*.json).
        return VisionResult(
...
# --- Phase 6B.85/6B.100: raw_vision_multi.json persistence -----------------
#
