"""
test_stable_attributes_6B163.py — Phase.163 Tier 3 stable-attribute
matching tests.
...
def test_match_person_tier3_fires_after_t2_miss() -> None:
    ...
    known = [_known_person("name one", clothing_color="other", stable=stable_known)]
...
def test_backward_compat_no_stable_attributes_block() -> None:
    ...
    known = [{"name": "name one", "role": "owner", "clothing_upper_color": "blue"}]
    person = _primary_person(
...
def test_silhouette_has_highest_weight() -> None:
    """Per Note 2026-08-29 priority order: silhouette is most important."""
...
def test_face_recognition_wins_over_stable_attributes() -> None:
    ...
    stable_known = _full_stable()
    known = [_known_person("name one", clothing_color="blue", stable=stable_known)]
