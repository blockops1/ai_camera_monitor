...
# Vehicle state
#   known_vehicles.json  — vehicles Note recognizes (color, type, label)
...
#   known_animals.json — animals Note recognizes (species, features, label).
...
KEYCHAIN_SERVICE = "<legacy-repo>.faces"
