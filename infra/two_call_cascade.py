...
def cascade_call1(
    ...
    call1_response = qwen_fn(
        ...
        # §11.115.20 (2026-09-03) — route Qwen call 1 through the
        # classify schema + prompt. Required so cascade_call1's
        # validate_classify_response receives {class, confidence,
        # reasoning}, not {primary_subject, vehicles[]}.
        mode="classify",
