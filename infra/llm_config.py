...
WHY HERE:
    ...
    infra/vision_analyzer.py and infra/alert_prompt.py. Phase 6B.146
    (maintainer 2026-08-27: "set the system up so it can be more general
...
# Phase 6B.158 (2026-08-28) — §11.81 swap from Qwen3-VL-8B + Qwen3.5-9B
