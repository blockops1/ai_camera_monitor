...
PUBLIC API:
    ...
    _format_vehicles_block(vision_result: dict) -> str
        Phase 6B.130 (§11.53) — build the 'Vehicles:' section for the
...
def _format_vehicles_block(vision_result: dict) -> str:
    """Phase 6B.130 (§11.53) — build a 'Vehicles:' section for the prompt.
