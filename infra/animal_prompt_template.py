...
INPUTS:
  - fn `build_animal_prompt(camera_name, captured_at, event_hint_block,
        ...
        contradicts it (Note 2026-08-29: "vision model is smarter
        than Yolo").
...
Design notes (Phase.165 §11.86.3, wider-scope revision 2026-08-29):
  ...
  Species is free-form (Qwen authoritative). Note 2026-08-29:
  ...
  distinctive_features[] is an ARRAY, not a string. Note 2026-08-29:
  ...
  YOLO hint is passed through but with explicit override language.
    Note 2026-08-29: "vision model is smarter than Yolo." Qwen is
