"""
animal_prompt_template.py — Phase.165 animal-event prompt + schema
(wider-scope revision 2026-08-29).

STATUS: provisional (Phase.165 §11.86.3; wider-scope schema)
...
INPUTS:
  - fn `build_animal_prompt(camera_name, captured_at, event_hint_block,
        ...
        contradicts it (the operator 2026-08-29: "vision model is smarter
        than Yolo").
...
WHY HERE:
  Phase.165 §11.86.3 (wider-scope revision 2026-08-29). Mirrors
...
CALLED BY:
  - infra.prompt_templates.select_prompt_template (Phase.165) when
...
Design notes (Phase.165 §11.86.3, wider-scope revision 2026-08-29):

  Species is free-form (Qwen authoritative). the operator 2026-08-29:
  ...
  distinctive_features[] is an ARRAY, not a string. the operator 2026-08-29:
  ...
  YOLO hint is passed through but with explicit override language.
    the operator 2026-08-29: "vision model is smarter than Yolo." Qwen is
...
ANIMAL_PROMPT_TEMPLATE_FORMAT = (
    ...
    "Animal-event analysis (Phase.165, wider-scope schema).\n\n"
