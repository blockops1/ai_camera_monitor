...
STATUS: provisional (Phase.165 §11.86.2; wider-scope rewrite 2026-08-29)
...
WHY HERE:
  Phase.165 §11.86.2 (wider-scope revision 2026-08-29). Mirrors
...
SPECIES_NORMALIZATION: dict[str, str] = {
    ...
    "sheep":             "sheep",
    "cow":               "cow",
    # Other common North American wildlife the operator might see
    "fisher":            "fisher",
    "fisher cat":        "fisher",
    "raccoon":           "raccoon",
    "deer":              "deer",
