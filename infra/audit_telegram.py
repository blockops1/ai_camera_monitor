    ...
    *,
    ...
    Args:
        channel: Logical channel that produced the send. Common values:
            ...
            "vehicle_arriving" — Phase 6B.9 message 1 ("Vehicle entering...")
        ...
        image_paths: Phase 6B.36 — list of absolute paths to the image
    ...
    """
    # Phase 6B.36: always emit image_paths so the audit line is
