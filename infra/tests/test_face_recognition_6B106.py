"""Unit tests for infra.face_recognition (Phase.106 lift).

The lifted module mirrors <legacy-repo>/src/face_recognition.py
...
def test_recognize_faces__exact_match_identifies_with_perfect_confidence(
    ...
    assert result["identified_person"] == "the operator"
