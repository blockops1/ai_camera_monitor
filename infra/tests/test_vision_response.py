...
class TestErrorResult:
    ...
    def test_error_sentinel_shape(self):
        ...
        assert result["vehicles"] == []
        assert result["primary_vehicle_index"] == 0
        # Phase 6B.78 (2026-08-14): motion fields removed from the
...
# =============================================================================
# Phase 6B.129b (§11.52) — backward-compat population from vehicles[]
# =============================================================================


class TestPopulateLegacyFieldsFromVehicles:
    """Phase 6B.129b — multi-vehicle crop schema requires Qwen to emit
...
# =============================================================================
# Phase 6B.130 (§11.53) — multi-vehicle Telegram-layer support
# =============================================================================


class TestPopulateLegacyMultiVehicleWideSurface:
    """Phase 6B.130 — _populate_legacy_fields_from_vehicles also writes
