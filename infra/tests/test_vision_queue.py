...
class TestPhase6B167ByCodeKeyedSets:
    ...
    Phase.168 (2026-08-31): the deployment switched from the legacy
    env format (codes like OUTSIDE_FRONT_SOLAR) to the NEW cameras.env
    schema (CAM{N} codes per Phase.167 §13.4). Production now uses
    ...
    def test_gatekeeper_set_is_code_keyed(self):
        ...
        # Phase.168: NEW schema uses CAM{N} codes; the legacy
    ...
    def test_phase6a_set_is_code_keyed(self):
        ...
        # Phase.168: NEW-schema CAM{N} codes must be present.
        for code in (
            "CAM1",
            "CAM3",
            "CAM4",
    ...
    def test_gatekeeper_and_phase6a_overlap(self):
        ...
        Phase.168: GATEKEEPER_CAMERAS includes all CAM{N} (the
