...
This helper renders the Qwen confidence line for the CAM1 lead motion
Telegram (Phase 6B.81 / PLAN.md §11.14.3.B). It surfaces the vision
model's per-vehicle confidence at the top of the alert body so maintainer can
