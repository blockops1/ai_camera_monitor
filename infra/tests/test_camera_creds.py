...
def env_file():
    ...
    Phase.167 §13.4 (Commit 6 scrub): operator IPs/names replaced with
...
# ---------------------------------------------------------------------------
# IP→HTTP_USER / IP→HTTP_PASS lookup helpers (Phase.166 §11.87.2)
# ---------------------------------------------------------------------------
#
...
class TestGetHttpCreds:
    ...
    def test_get_http_user_unknown_ip_returns_none(self, env_file_full_fleet):
        ...
        assert get_http_user("192.168.99.99", env_file_full_fleet) is None
...
# ---------------------------------------------------------------------------
# browser_chrome_path env var (Phase.166 §11.87.2)
# ---------------------------------------------------------------------------
