...
Phase.80 (PLAN §11.13) — Scheduled RTSP reconnect.
...
Covers:
    ...
    - Per-camera reader registry (Phase.87, PLAN §11.17):
...
# Phase.167 (PLAN §13.5 Commit 10) — code-keyed registry. New primary API
...
def _sample_cameras():
    ...
    Uses infra.cameras.CameraSpec dataclass (Phase.167 §13.5 Commit 5).
...
class TestPhase6B167ByCodeRegistry:
    """Phase.167 §13.5 Commit 10 — code-keyed reader registry.
...
# Phase.155 (PLAN §11.78) — max-attempts cap on failure-driven reconnects.
