"""
Tests for scripts/read_alarm_settings.py — Phase.166 §11.87.5.
...
REPO = Path("<install-path>/ai_camera_monitor")
...
def _sample_cameras_dict():
    ...
    Phase.167 §13.7: synthetic data only (10.0.0.x, generic labels).
...
# ============================================================================
# Phase.167 §13.4 — `--camera` + `--list-cameras` flags
#
...
class TestPhase6B167CameraFlag:
    """Phase.167 §13.4 — `--camera <label>` filters to a single camera."""
