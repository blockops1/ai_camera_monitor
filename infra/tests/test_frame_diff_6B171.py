"""Phase.171 — subject_bbox_from_mask unit + regression tests.

PURPOSE
-------
Phase.171 adds `subject_bbox_from_mask()` to infra/frame_diff.py. The
...
STRICT COMMIT (Note 2026-09-01): no min_subject_area_px floor, no
...
def test_subject_bbox_tighter_than_stored_for_morning_alerts():
    ...
    for alert_id, frame_paths in frames_by_alert.items():
        # Phase.169: frame_paths[1] = frame_2, frame_paths[2] = frame_3.
