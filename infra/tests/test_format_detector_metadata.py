...
This helper renders the OFS lead motion Telegram's "detector metadata"
section (Phase 6B.81 / PLAN.md §11.14.3.A). It surfaces the motion
detector's structured output as labeled lines so maintainer can tell at a
