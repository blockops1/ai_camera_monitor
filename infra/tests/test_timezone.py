"""Unit tests for infra.timezone — Phase 6B.99 EDT conversion helpers.

maintainer directive (2026-08-19): UTC timestamps from Reolink webhooks must be
...
def test_to_edt_string_round_trip_farm_vision_payload() -> None:
    """Real-world Reolink payload from a 2026-08-19 OFG capture (12:14 EDT)."""
