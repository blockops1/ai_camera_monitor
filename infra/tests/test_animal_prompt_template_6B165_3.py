...
animal prompt template (Phase 6B.165 §11.86.3, revised 2026-08-29).
...
class TestSchemaFields:
    ...
    def test_schema_species_is_free_form_string(self):
        ...
        assert legacy_enum not in schema, (
            ...
            "maintainer 2026-08-29 wants free-form species"
        )
    ...
    def test_schema_distinctive_features_is_an_array(self):
        ...
        maintainer 2026-08-29: "the distinguishing characteristics result
    ...
    def test_schema_does_not_have_legacy_breed_field(self):
        ...
        maintainer's pivot (2026-08-29) treats free-form species as the
...
class TestPromptBody:
    ...
    def test_prompt_body_overrides_yolo_hint(self):
        ...
        maintainer 2026-08-29: "vision model is smarter than Yolo" —
...
class TestBuildFn:
    ...
    def test_substitutes_event_hint_block(self):
        out = build_animal_prompt(
            camera_name="CAM1",
            captured_at="2026-08-30 14:00 EDT",
            event_hint_block="[Animal event, CAM1, 14:00]",
        )
        assert "[Animal event, CAM1, 14:00]" in out
...
class TestSelectRoute:
    ...
    def test_mode_animal_returns_animal_template(self):
        out = select_prompt_template(
            ...
            camera_name="CAM1",
            captured_at="2026-08-30 14:00 EDT",
            event_hint_block="[Animal event, CAM1]",
            mode="animal",
            species_hint="dog",
        )
