...
Phase 6B.111 §11.41 (per-plan pair to 6B.110 quick_classifier factory).
...
CALLED BY:
    infra/quick_classifier.py: get_classifier_for_time() factory (Phase 6B.111)
...
RELATED:
    ...
    - models/yolov8n-night.onnx: night model (Phase 6B.111 build), loaded when True
"""
...
def now_edt_iso(dt_utc: datetime | None = None) -> str:
    ...
    Phase 6B.114 (2026-08-25) — maintainer wants the actual Telegram-send
