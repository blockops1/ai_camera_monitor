      ...
      Schema:
        {
          ...
          "cameras": {
            "<camera label>": {  # e.g. "Outside Front Solar"
...
def resolve_for_camera(
    ...
    - label: camera label as it appears in recipe.cameras (e.g.
      "Outside Front Solar"). Unknown labels are tolerated: the
