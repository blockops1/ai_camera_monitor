...
# NOT <legacy-repo>/data. Per AGENTS.md §3 isolation rule.
from infra.paths import DATA_DIR as _DATA_DIR
from infra.timezone import parse_iso as _parse_iso  # promoted from here (Phase.99)
...
def set_last_vision(
    ...
    Args:
        camera_name: Friendly name (e.g. "Front Door Outside")
