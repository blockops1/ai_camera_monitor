...
DOES NOT DO:
    ...
    - Log the send to the audit line — infra.audit_telegram owns that.
      Phase.124 (2026-08-26, Note directive after 2 morning
...
def _audit(
    *,
    ...
    Phase.124: this is the SINGLE chokepoint. Callers no longer
...
def send_message(
    ...
    *,
    ...
    Phase.124: emits one OUTBOUND_TELEGRAM audit line on every return
...
def send_photo(
    ...
    *,
    ...
    Phase.124: emits one OUTBOUND_TELEGRAM audit line on every return path.
...
# Phase.63 (2026-08-07) — sendMediaGroup helper for multi-frame
# fallback alerts (used when vision fails on OFS vehicle webhooks but
...
def send_photo_group(
    ...
    *,
    ...
    Args:
        ...
        alert_id/channel/event/v_id: Phase.124 audit context.
...
def send_photo_with_caption(
    ...
    *,
    ...
    Phase.124: emits one OUTBOUND_TELEGRAM audit line on every
