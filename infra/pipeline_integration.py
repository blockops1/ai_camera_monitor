...
from infra.frame_capture import QWEN_INPUT_SIZE, crop_face_region_from_4k
...
def run_phase6a_recognition(
    ...
    try:
        ...
        for attempt, (idx, bbox_small) in enumerate(candidates, start=1):
            ...
            # Phase.131 (the operator 2026-08-26): Qwen now receives the frame at
