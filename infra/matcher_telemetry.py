...
class _MatchTelemetry:
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        with self._lock:
            ...
            # Phase 6B.26a — pull shadow counters from vehicle_matcher.
            ...
            return {
                ...
                # Phase 6B.26a — side-by-side shadow comparison counters.
...
def start_telemetry_snapshot_thread(
    ...
    Phase 6B.25 — gives operators cross-restart visibility into matcher
    ...
    def _run():
        while not _telemetry_snapshot_stop.is_set():
            ...
            # Phase 6B.47 — log scored disagreement rate per maintainer
