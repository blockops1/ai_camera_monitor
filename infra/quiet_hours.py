"""
quiet_hours.py — Phase 6B.52 / 6B.112 — Quiet-hours Telegram suppression for outside cameras.
...
WHY HERE:
    maintainer 2026-08-04 OOB: "I am thinking that maybe we need to turn off
    alerts from CAM1 and CAM5 at night." Investigation showed the noise
    was county-road headlights triggering AI vehicle/people/animal
    detection on the four outside cameras (CAM1, CAM5, CAM4, CAM2).
    ...
    Phase 6B.112 (maintainer 2026-08-24): time logic refactored from a fixed
...
RELATED:
    ...
    - infra.time_of_day — night-window source of truth (Phase 6B.111 §11.41)
"""
from __future__ import annotations

from datetime import datetime

# Cameras subject to quiet-hours Telegram suppression (Phase 6B.52).
...
def in_quiet_hours(now: datetime, camera_name: str) -> bool:
    ...
    Phase 6B.112: "night" is now derived from astronomical sunrise/sunset
    ...
    Phase 6B.167 §13.4 (T3 C17): camera_name is translated via
