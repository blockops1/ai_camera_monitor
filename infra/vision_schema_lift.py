...
WHY HERE:
    ...
    identifying a vehicle. Verified on alert 0eefa8e9 (drive-by
    15:08 EDT, OFG): crop vision returned make+model+color with
    high confidence, alert LLM produced "empty exterior scene" L0.
