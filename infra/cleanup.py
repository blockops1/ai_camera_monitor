...
DOES NOT DO:
    ...
    - Rotate or compact the audit log — audit log rotation was owned by
      infra.audit (retired Phase §11.90, 2026-09-01; restored at
      ~/archive/2026-09-01-legacy-code/audit.py if needed).
      audit/ dir is currently not pruned by this module.
...
CALLS INTO:
    ...
    - infra.audit: prune_old_audit_logs()  [RETIRED §11.90 — restored at
      ~/archive/2026-09-01-legacy-code/audit.py if needed]
