"""
unified_vision.py — Phase 6B.113 §11.113 unified-prompt variant for Qwen3-VL.
...
WHY HERE:
  Phase §11.113 leakage test. maintainer's design choice (2026-09-02):
...
def build_unified_prompt(
    ...
    Args:
        camera_name: short camera code (e.g. "CAM1", "CAM1").
