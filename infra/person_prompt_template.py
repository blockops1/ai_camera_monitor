...
DOES NOT DO:
  ...
  - Does NOT detect motion or faces. (See infra.motion_types +
    ...
    since Phase.115; infra.motion_detector is now a dataclass shim.)
...
Design notes (Phase.106, Note green-lit 2026-08-22):
  - Qwen3-VL is asked for the FULL attribute set per Qwen2.5-VL +
    ...
    face_bbox). Note: "fully use this vision model, do everything
