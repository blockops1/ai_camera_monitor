...
KNOWN_TESLA = {
    "id": "v_rolf_darkblue_tesla_y",
    "label": "maintainer's Dark Blue Tesla Model Y",
    "color": "dark blue",
    "type": "SUV",
    "make": "Tesla",
    "model": "Model Y",
...
class TestSuccessfulMatch:
    def test_perfect_signature_returns_match_verdict(self, known_fleet):
        ...
        assert result.known_vehicle["id"] == "v_rolf_darkblue_tesla_y"
...
class TestScoreTopN:
    def test_score_top_n_returns_top_n_in_modular_shape(self, known_fleet):
        ...
        assert result[0][0] == "v_rolf_darkblue_tesla_y"
