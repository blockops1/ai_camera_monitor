"""
test_legacy_match_adapter_6B105.py — Phase 6B.105 unit tests for the
...
Per Phase 6B.103's scripts/probe_matcher_comparison.py, the legacy
...
KNOWN_TESLA = {
    "id": "v_<owner-name>_darkblue_tesla_y",
    "label": "<owner-name>'s Dark Blue Tesla Model Y",
    "color": "dark blue",
    "type": "SUV",
    "make": "Tesla",
    "model": "Model Y",
...
class TestSuccessfulMatch:
    def test_perfect_signature_returns_match_verdict(self, known_fleet):
        ...
        assert result.known_vehicle["id"] == "v_<owner-name>_darkblue_tesla_y"
...
class TestScoreTopN:
    def test_score_top_n_returns_top_n_in_modular_shape(self, known_fleet):
        ...
        assert result[0][0] == "v_<owner-name>_darkblue_tesla_y"
