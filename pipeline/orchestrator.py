...
# Phase 6B.105 (2026-08-20) — match step delegates to the legacy
...
# from Phase 6B.103). The adapter wraps infra.vehicle_matcher.match_vehicle_scored
...
def run_pipeline(
    ...
    Steps:
      1. Motion detection (gate-driven, Phase 6B.115).
    ...
    # ------------------------------------------------------------------
    # Step 1: motion detection (gate-driven, Phase 6B.115)
    # ------------------------------------------------------------------
    # Phase 6B.115 (§11.46.6): prefer in-memory frames if provided,
    ...
    # Phase 6B.144 (§11.66): identify_from_crops now accepts a
    ...
    # Step 3: matching
    # ------------------------------------------------------------------
    # Phase 6B.105 (2026-08-20): use the legacy 15-dim scorer via the
    ...
    if isinstance(match_verdict, MatchVerdict):
        ...
        # Phase 6B.105: legacy 15-dim scorer for parity with the match step.
