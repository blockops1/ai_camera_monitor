...
Phase 6B.105 (2026-08-20) — maintainer asked to wire pipeline/orchestrator.py into
...
scripts/probe_matcher_comparison.py from Phase 6B.103). To preserve
...
WHY HERE:
    Phase 6B.105 plan doc §11.33. The legacy 15-dim scorer
...
RELATED:
    ...
    - vehicle_matcher/matcher.py (modular scoring engine, 4 dims, 4-dim path not used in production per Phase 6B.105)
    - scripts/probe_matcher_comparison.py (Phase 6B.103, proves legacy > modular)
"""
